...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { base } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32@v0.2.0-deno/mod.js';
```
